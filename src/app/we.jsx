    ...
    <section className="text-black text-center relative" id="nosotros">
        ...
        <article className="my-36 flex flex-col justify-center items-center absolute lg:mt-20 top-0 left-0 lg:left-[6%] xl:top-[0%] xl:left-[2%] text-white">
                ...
                <motion.h1
                    ...
                    delay: 0.1,
                    ease: [0, 0.71, 0.2, 1.01]
                    }}  className="text-3xl lg:text-7xl spacebold flex flex-row relative mt-10"
                >
                    MEGA
            ...
            <motion.p
                ...
                delay: 0.6,
                ease: [0, 0.71, 0.2, 1.01]
            }}  className="w-full lg:w-1/3 text-xs max-sm:px-4 lg:text-md xl:text-xl max-sm:leading-loose"
            >
